...
public class Quizzer extends Activity {
	...
	protected void startQuiz (String category) {
		...
		word_view.setGravity(Gravity.CENTER);
...
//		Log.w ("Quiz setup", "screen width is " + screen_width);
		...
		word_view.setTextColor(Color.BLUE);
...
//		quiz_view.addView (progress_bar, pb_lp);
        ...
        adView.setAdUnitId("ca-app-pub-5735264719731428/1962009795");

        l_layout.addView(this.adView);
	...
	protected void newQuestion () {
		...
		tl_button.setBackgroundColor (Color.GRAY);
		tr_button.setBackgroundColor (Color.GRAY);
		bl_button.setBackgroundColor (Color.GRAY);
		br_button.setBackgroundColor (Color.GRAY);
        ...
        tl_button.setTextColor(Color.BLACK);
        tr_button.setTextColor(Color.BLACK);;
        bl_button.setTextColor(Color.BLACK);;
        br_button.setTextColor(Color.BLACK);
