...
import jason.cruz.countryquiz.R;
...
public class MainActivity extends Activity {
    ...
    private void initializeDisplay () {
        ...
        top_menu_title.setTextSize(50);

        android.view.Display display = ((android.view.WindowManager)getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();
        int screen_width = display.getWidth();
        int buttons_width = (int)(screen_width);
        ...
        for (int i = 0; i < categories.length; i++) {
            ...
            category_reset_button.setText("Reset Scores");
    ...
    protected void startQuiz (String category, Button view_clicked) {
        ...
        Toast.makeText(getApplicationContext(),
                "Let's Start The Quiz on "+category+"!", Toast.LENGTH_SHORT).show();
    ...
    private class StartQuizListener implements OnClickListener {
        ...
        public StartQuizListener (MainActivity f, String c) {
            category = c;
            app = f;
        }
    ...
    private class ResetQuizListener implements OnClickListener {
        ...
        private ResetQuizListener (MainActivity f, String c) {
            category = c;
            app = f;
        }
        ...
        public void onClick(View v) {
            new AlertDialog.Builder(app)
                    ...
                    .setTitle("Reset Scores on" + category)
                    .setMessage("Are you sure you want to reset your scores on this category?")
    ...
    private class ReverseListener implements OnClickListener {
        ...
        private ReverseListener (MainActivity f) {
            app=f;
        }
